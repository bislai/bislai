...
$(function () {
    ...
    function mapDraw(geojson) {
        ...
        var tooltip = d3.select("#map").append("div").attr("class", "tooltip tooltip-cs");

        var featureElement = svg.selectAll("path").data(geojson.features).enter().append("path").attr("class", "distritosCS").on("mouseover", showTooltip).transition().duration(200);
        ...
        function showTooltip(geoJson) {
            // moveTooltip();
            tooltip.style("display", "block").html('<h4 class="tooltipTitulo">' + geoJson.properties.distrito + '</h4>' + '<div class="container-tooltip-partido"><p class="tooltipPartido"><span class="resultado-izda"><span class="titulo-partido">2015</span><span style="width:' + geoJson.properties.quince_p * 1.65 + '%" class="bgc-cs"></span></span><span class="resultado"><span class="resultadoVotos"> ' + geoJson.properties.quince_p + '%</span><span class="resultadoVotos">' + geoJson.properties.quince_v + ' votos</span><p/>').transition().duration(200);
        }
...
var csvElements = ['datos/ciudadanos/en-su-contra.csv', 'datos/ciudadanos/a-su-favor.csv', 'datos/ciudadanos/abstencion.csv', 'datos/ciudadanos/en-contra.csv', 'datos/ciudadanos/a-favor.csv'];
