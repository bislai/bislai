...
var partidos = ["ZEC", "PSOE", "C'S", "CHA"];

var colorPartidos = ['rgba(154, 22, 34, 1)', 'rgba(227, 6, 19, 1)', 'rgba(240, 122, 54, 1)', 'rgba(239, 176, 39, 1)'];
    ...
    var myBarenContra = new Chart(enContra, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [61, 31, 5, 46],
                backgroundColor: ['rgba(154, 22, 34, 1)', 'rgba(227, 6, 19, 1)', 'rgba(240, 122, 54, 1)', 'rgba(239, 176, 39, 1)']
            }]
        }
    });
}
