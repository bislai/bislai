...
var partidos = ["PP", "ZEC", "C'S", "CHA"];

var colorPartidos = ['rgba(0, 128, 184, 1)', 'rgba(154, 22, 34, 1)', 'rgba(240, 122, 54, 1)', 'rgba(239, 176, 39, 1)'];
    ...
    var myBarenContra = new Chart(enContra, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [17, 28, 6, 9],
                backgroundColor: ['rgba(0, 128, 184, 1)', 'rgba(154, 22, 34, 1)', 'rgba(240, 122, 54, 1)', 'rgba(239, 176, 39, 1)']
            }]
        }
    });
}
